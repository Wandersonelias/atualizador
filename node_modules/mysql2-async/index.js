...
function stream(query, options) {
    ...
    let canceled = false;
    const stream = new stream_1.Readable({ ...options, objectMode: true });
    stream._read = () => {
        var _a;
        (_a = anyquery._connection) === null || _a === void 0 ? void 0 : _a.resume();
    };
...
class Queryable {
    ...
    async getvals(sql, binds, options) {
        const rows = await this.getall(sql, binds, options);
    ...
    stream(sql, bindsOrOptions, options) {
        ...
        const result = (options === null || options === void 0 ? void 0 : options.saveAsPrepared) ? this.conn.execute({ ...options, sql, values: binds }) : this.conn.query({ ...options, sql, values: binds });
        return stream(result, options !== null && options !== void 0 ? options : {});
    }
...
class Db extends Queryable {
    constructor(config) {
        ...
        const pool = mysql2_1.default.createPool({
            ...
            user: (_h = (_g = (_f = config === null || config === void 0 ? void 0 : config.user) !== null && _f !== void 0 ? _f : process.env.MYSQL_USER) !== null && _g !== void 0 ? _g : process.env.DB_USER) !== null && _h !== void 0 ? _h : 'root',
            password: (_l = (_k = (_j = config === null || config === void 0 ? void 0 : config.password) !== null && _j !== void 0 ? _j : process.env.MYSQL_PASS) !== null && _k !== void 0 ? _k : process.env.DB_PASS) !== null && _l !== void 0 ? _l : 'secret',
            database: (_p = (_o = (_m = config === null || config === void 0 ? void 0 : config.database) !== null && _m !== void 0 ? _m : process.env.MYSQL_DATABASE) !== null && _o !== void 0 ? _o : process.env.DB_DATABASE) !== null && _p !== void 0 ? _p : 'default_database',
